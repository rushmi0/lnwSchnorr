    ...
    fun multiplyPoint(
        ...
        try {
            ...
            for (i in 1..<binary.length) {
                ...
                // * binary digit ที่ตำแหน่ง i เป็น '1'  ให้บวกจุดเริ่มต้น (current) เข้ากับจุดปัจจุบัน (currentPoint)
                if (binary[i] == '1') {
            ...
            e.printStackTrace()
            // ในกรณีที่เกิด Exception ให้ส่งคืนค่าที่เหมาะสม เช่น null หรือ ecc.PointField ว่าง
            return null!!
        }
